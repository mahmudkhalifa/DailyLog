...
namespace Data.DailyLog.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((Data.DailyLog.EntityType)typeOfEntity)
			{
		...
		public DataSource2<LogEntity> Log {	get { return new DataSource2<LogEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
